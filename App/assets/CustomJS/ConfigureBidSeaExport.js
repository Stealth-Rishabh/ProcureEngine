...
function ConfigureBidForSeaExportTab1() {
    ...
    /*  var StartDT = new Date($('#txtbidDate').val().replace('-', ''));
      if ($('#txtbidDate').val() != null && $('#txtbidDate').val() != "") {
          ...
          // StartDT = new Date(StartDT1.replace('at', '')).toLocaleString();
          StartDT = new Date(StartDT.replace('at', ''));
      }*/
    ...
    if (form.valid() == true) {
        ...
        if ($('#add_or').text() == "Modify") {
            ...
            if ($('#dropuom').val() == '') {
                ...
                error.show();
                $('#spandanger').html('Minimum decrement should be less than bid unit price.');
                Metronic.scrollTo(error, -200);
                error.fadeOut(3000);
                jQuery.unblockUI();
                return false;
                ...
                error.show();
                $('#spandanger').html('Bid unit price should not be less than Floor Price + Price Decrement amount.');
                Metronic.scrollTo(error, -200);
                error.fadeOut(3000);
                jQuery.unblockUI();
                return false;
                ...
                error.show();
                $('#spandanger').html('Minimum decrement should be less than 20% of Bid Unit Price.');
                Metronic.scrollTo(error, -200);
                error.fadeOut(3000);
                return false;
            }
            ...
            if (parseFloat(removeThousandSeperator($('#txtminimumdecreament').val())) > parseFloat(removeThousandSeperator($('#txtCeilingPrice').val()))) {
                ...
                error.show();
                $('#spandanger').html('Bid unit price Price should not be less than Floor + Price Decrement amount.');
                Metronic.scrollTo(error, -200);
                error.fadeOut(3000);
                jQuery.unblockUI();
                return false;
...
function ParametersQuery() {
    ...
    if ($("#ddlAuctiontype").val() == 81 || $("#ddlAuctiontype").val() == 83) {
        ...
        if (!jQuery("#tblServicesProduct thead").length) {
            jQuery("#tblServicesProduct").append("<thead><tr style='background: gray; color: #FFF;'><th>S No</th><th 'width:20%!important;'></th><th>Item Code</th><th>Item/Service</th><th>Remarks</th><th>Target Price</th><th>Hide Target Price</th><th>Quantity</th><th>UOM</th><th>Bid Unit Price</th><th>Floor/ Min. Price</th><th>Price Decrement Amount</th><th> Price Decrement Frequency</th><th>PO Unit Rate</th><th>PO No.</th><th>PO Vendor Name</th><th>PO Date</th><th>PO Value</th></tr></thead>");
        ...
        if (!jQuery("#tblServicesProductPrev thead").length) {
            jQuery("#tblServicesProductPrev").append("<thead><tr style='background: gray; color: #FFF;'><th>S No</th><th>Item Code</th><th>Item/Service</th><th>Remarks</th><th>Target Price</th><th>Hide Target Price</th><th>Quantity</th><th>UOM</th><th>Bid Unit Price</th><th>Floor/ Min. Price</th><th>Price Decrement Amount</th><th> Price Decrement Frequency</th><th>PO Unit Rate</th><th>PO No.</th><th>PO Vendor Name</th><th>PO Date</th><th>PO Value</th></tr></thead>");
        ...
        success: function (BidData) {
            ...
            if (BidData[0].bidSeaExportDetails.length > 0) {
                ...
                if (BidData[0].bidDetails[0].bidForID == 81 || BidData[0].bidDetails[0].bidForID == 83) {
                    ...
                    jQuery("#tblServicesProduct").append("<thead><tr style='background: gray; color: #FFF;'><th>S No</th><th style='width:10%!important;'></th><th>Item Code</th><th>Item/Service</th><th>Remarks</th><th>Target Price</th><th>Hide Target Price</th><th>Quantity</th><th>UOM</th><th>Bid Unit Price</th><th>Floor/ Min. Price</th><th>Price Decrement Amount</th><th> Price Decrement Frequency</th><th>PO Unit Rate</th><th>PO No.</th><th>PO Vendor Name</th><th>PO Date</th><th>PO Value</th></tr></thead>");
                    jQuery("#tblServicesProductPrev").append("<thead><tr style='background: gray; color: #FFF;'><th>S No</th><th style='width:20%!important;'>Item Code</th><th>Item/Service</th><th>Remarks</th><th>Target Price</th><th>Hide Target Price</th><th>Quantity</th><th>UOM</th><th>Bid Unit Price</th><th>Floor/ Min. Price</th><th>Price Decrement Amount</th><th> Price Decrement Frequency</th><th>PO Unit Rate</th><th>PO No.</th><th>PO Vendor Name</th><th>PO Date</th><th>PO Value</th></tr></thead>");
                    for (var i = 0; i < BidData[0].bidSeaExportDetails.length; i++) {
                        rowAppItems = rowAppItems + 1
                        rowAppItemsrno = rowAppItemsrno + 1;
    ...
    if (loopcount > 200) {
        ...
        for (i = 0; i < loopcount; i++) {
            ...
            if ($.trim(result[i].ItemService) == '' || $.trim(result[i].ItemService).length > 200) {
                ...
                $("#error-excelparameter").show();
                $("#errspan-excelparameter").html('Bid Unit Price should be in numbers only of Item no ' + (i + 1) + '.');
                $("#file-excelparameter").val('');
                return false;
            }
                ...
                $("#error-excelparameter").show();
                $("#errspan-excelparameter").html('Minimum decrement should be less than bid unit price of Item no ' + (i + 1) + '. Please fill and upload the file again.');
                $("#file-excelparameter").val('');
                return false;
            }
                ...
                $("#error-excelparameter").show();
                $("#errspan-excelparameter").html('Minimum decrement should be less than 20% of Bid Unit Price of Item no ' + (i + 1) + '. Please fill and upload the file again.');
                $("#file-excelparameter").val('');
                return false;
            }
