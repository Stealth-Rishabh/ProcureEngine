    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if (data[0].quotesDetails.length > 0) {
                ...
                jQuery('#tblServicesProduct').append('<thead><tr style="background: grey; color:light black;"><th style="width:5%!important;"></th><th style="width:40%!important;">Short Name</th><th>Quantity</th><th>UOM</th><th>' + taxHRTextinc + '</th><th>' + taxHRTextEx + '</th><th>' + HRUnitRate + '</th><th>Description</th><th>Comments</th></tr></thead>');
                jQuery('#tblServicesProductforexcel').append('<thead><tr style="background: grey; color:light black;"><th style="width:5%!important;"></th><th style="width:40%!important;">Short Name</th><th>Quantity</th><th>UOM</th><th>' + taxHRTextinc + '</th><th>' + taxHRTextEx + '</th><th>' + HRUnitRate + '</th><th>Description</th><th>Comments</th></tr></thead>');
                for (var r = 0; r < data[0].boqSummary.length; r++) {
                    for (var i = 0; i < data[0].quotesDetails.length; i++) {
                        if (data[0].boqSummary[r].boqsheetName == data[0].quotesDetails[i].boqsheetName) {
                            ...
                            if (data[0].quotesDetails[i].srno == 1 && data[0].quotesDetails[i].rfqParameterParentID == "0" && data[0].quotesDetails[i].rfqtcid == "0") {
                                ...
                                if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                    totalamount = data[0].quotesDetails[i].rfqVendorPricewithTax * data[0].quotesDetails[i].quantity;
                                    if (_basicPrice > 0) {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td id=shortSP' + pid + ' style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithoutGST).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithTax).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators(totalamount.round(2)) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + '><tr name=' + sheet.split(' ').join('_') + '><td style="width:5%!important;" data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithoutGST).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithTax).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators(totalamount.round(2)) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                    else {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td style="width:40%!important;" id=shortSP' + pid + '><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + '><tr name=' + sheet.split(' ').join('_') + '><td style="width:5%!important;" data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                    totalamountsum = totalamountsum + totalamount;
                                    withoutGSTValue = data[0].quotesDetails[i].rfqVendorPricewithoutGST
                                }
                                    ...
                                    if (_basicPrice > 0) {
                                        ...
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr style="background: #ccc; color:grey;" name=' + sheet.split(' ').join('_') + '><td data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Quoted</b></td><td class=text-right><b>Quoted</b></td><td class=text-right><b>Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + '><tr name=' + sheet.split(' ').join('_') + '><td style="width:5%!important;" data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Quoted</b></td><td class=text-right><b>Quoted</b></td><td class=text-right><b>Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                    else {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr style="background: #ccc; color:grey;" name=' + sheet.split(' ').join('_') + '><td data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + ' ><tr name=' + sheet.split(' ').join('_') + '><td style="width:5%!important;" data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].quantity)).round(2)) + '</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                ...
                                for (var j = 0; j < data[0].quotesDetails.length; j++) {
                                    if (j == 0) {
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + (data[0].quotesDetails[i].unitRate) + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + (data[0].quotesDetails[i].unitRate) + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                        }
                                        else {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>Basic Price</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                    ...
                                    if (data[0].quotesDetails[j].rfqtcid != 0 && data[0].quotesDetails[i].rfqParameterId == data[0].quotesDetails[j].rfqParameterId) {
                                        ...
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + (data[0].quotesDetails[j].termRate) + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>' + data[0].quotesDetails[j].termRate + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                        }
                                        else {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Quoted</td><td class=text-right>Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Quoted</td><td class=text-right>Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td class=text-right>' + '' + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                ...
                                for (var j = counter; j < data[0].quotesDetails.length; j++) {
                                    ...
                                    if (data[0].quotesDetails[i].uom == "" && data[0].quotesDetails[i].quantity == 0 && data[0].quotesDetails[i].boqsheetName == data[0].quotesDetails[j].boqsheetName && data[0].quotesDetails[j].rfqParameterParentID == "0" && data[0].quotesDetails[j].rfqtcid == "0") {
                                        ...
                                        for (var k = j; k < data[0].quotesDetails.length; k++) {
                                            if (data[0].quotesDetails[k].rfqtcid == "0" && data[0].quotesDetails[j].rfqParameterParentID == "0" && data[0].quotesDetails[k].rfqParameterParentID == "0" && data[0].quotesDetails[i].uom == "" && data[0].quotesDetails[i].quantity == 0 && data[0].quotesDetails[k].boqsheetName == data[0].quotesDetails[j].boqsheetName) {
                                                ...
                                                for (var l = k; l < data[0].quotesDetails.length; l++) {
                                                    if (data[0].quotesDetails[l].rfqtcid == "0" && data[0].quotesDetails[l].rfqParameterParentID == "0" && data[0].quotesDetails[l].uom == "" && data[0].quotesDetails[l].quantity == 0 && data[0].quotesDetails[k].rfqParameterId == data[0].quotesDetails[l].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[k].boqsheetName) {
                                                        ...
                                                        for (var m = l; m < data[0].quotesDetails.length; m++) {
                                                            if (data[0].quotesDetails[j].rfqtcid == "0" && data[0].quotesDetails[m].uom == "" && data[0].quotesDetails[m].quantity == 0 && data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[m].boqsheetName) {
                                                                ...
                                                                $('#TblMH1PE' + l).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td>' + data[0].quotesDetails[m].srno + '</td><td id=shortP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanP' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[m].quantity)).round(2)) + '</td><td id=uomP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="form-control thousandseparated text-right">' + thousands_separators((data[0].quotesDetails[m].itemPrice)).round(2)) + '</td><td id=commP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                                $('#TblMH1P' + l).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td>' + data[0].quotesDetails[m].srno + '</td><td id=shortP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanP' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[m].quantity)).round(2)) + '</td><td id=uomP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="form-control thousandseparated text-right">' + thousands_separators((data[0].quotesDetails[m].itemPrice)).round(2)) + '</td><td id=commP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                            }
                                                        }
                                                    }
                                                    else if (data[0].quotesDetails[k].rfqParameterId == data[0].quotesDetails[l].rfqParameterParentID && data[0].quotesDetails[l].uom != "" && data[0].quotesDetails[l].quantity != 0 && data[0].quotesDetails[l].rfqtcid == "0") {
                                                        pid = data[0].quotesDetails[l].rfqParameterId;
                                                        sheet = data[0].quotesDetails[l].boqsheetName;
                                                        srno = data[0].quotesDetails[l].srno;
                                                        parentid = data[0].quotesDetails[l].rfqParameterParentID

                                                        $('#TblMHP' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + srno + '>' + pid + '</td><td>' + srno + '</td><td id=shortP' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanP' + pid + '>' + thousands_separators((data[0].quotesDetails[l].quantity)).round(2)) + '</td><td id=uomP' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators((data[0].quotesDetails[l].itemPrice)).round(2)) + '</td><td id=commP' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                        $('#TblMHPE' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDPE' + srno + '>' + pid + '</td><td>' + srno + '</td><td id=shortPE' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanPE' + pid + '>' + thousands_separators((data[0].quotesDetails[l].quantity)).round(2)) + '</td><td id=uomPE' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators((data[0].quotesDetails[l].itemPrice)).round(2)) + '</td><td id=commPE' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                    }
                                                        ...
                                                        for (var m = l; m < data[0].quotesDetails.length; m++) {
                                                            ...
                                                            if (data[0].quotesDetails[m].rfqtcid == "0" && data[0].quotesDetails[m].quantity == "" && data[0].quotesDetails[m].quantity == 0 && data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[m].boqsheetName) {
