    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if (data[0].quotesDetails.length > 0) {
                ...
                jQuery('#tblServicesProduct').append('<thead><tr style="background: #ccc; color:grey;white-space:nowrap!important;"><td colspan=4></td><td class=text-right><b>Total</b></td><td class=text-right><b>' + thousands_separators(totalamountsum.round(3)) + '</b></td><td>&nbsp;</td><td>&nbsp;</td></tr></thead>');
                jQuery('#tblServicesProductforexcel').append('<thead><tr><td colspan=4></td><td class=text-right><b>Total</b></td><td class=text-right><b>' + thousands_separators(totalamountsum.round(3)) + '</b></td><td>&nbsp;</td><td>&nbsp;</td></tr></thead>');
