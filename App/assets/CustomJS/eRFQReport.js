...
$("#btnExport").click(function (e) {
    ...
    //abheedev 14/03/2023
    var table_html = table_div.outerHTML.replace(/#/g, "").replace(/ /g, '%20');
                        ...
                        if (data[0].boqSummary[r].boqsheetName == data[0].quotesDetails[i].boqsheetName) {
                            ...
                            if (data[0].quotesDetails[i].srno == 1 && data[0].quotesDetails[i].rfqParameterParentID == "0" && data[0].quotesDetails[i].rfqtcid == "0") {
                                ...
                                if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                    totalamount = data[0].quotesDetails[i].rfqVendorPricewithTax * data[0].quotesDetails[i].quantity;
                                    if (_basicPrice > 0) {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + ' class=accordion-toggle style="width:5%!important;"><button type=button class="btn btn-default btn-xs" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td id=shortSP' + pid + ' style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithoutGST).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithTax).round(2)) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                ...
                                for (var j = 0; j < data[0].quotesDetails.length; j++) {
                                    ...
                                    if (data[0].quotesDetails[j].rfqtcid != 0 && data[0].quotesDetails[i].rfqParameterId == data[0].quotesDetails[j].rfqParameterId) {
                                        ...
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + (data[0].quotesDetails[j].termRate) + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + data[0].quotesDetails[j].termRate + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
