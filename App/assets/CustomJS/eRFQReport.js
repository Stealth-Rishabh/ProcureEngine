    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if (data[0].quotesDetails.length > 0) {
                ...
                jQuery('#tblServicesProduct').append('<thead><tr style="background: grey; color:light black;"><th style="width:5%!important;"></th><th style="width:4%!important">SrNo</th><th style="width:40%!important;">Short Name</th><th>UOM</th><th>' + taxHRTextinc + '</th><th>' + taxHRTextEx + '</th><th>Description</th><th>Comments</th></tr></thead>');
                jQuery('#tblServicesProductforexcel').append('<thead><tr style="background: grey; color:light black;"><th style="width:5%!important;"></th><th style="width:4%!important">SrNo</th><th style="width:40%!important;">Short Name</th><th>UOM</th><th>' + taxHRTextinc + '</th><th>' + taxHRTextEx + '</th><th>Description</th><th>Comments</th></tr></thead>');
                for (var r = 0; r < data[0].boqSummary.length; r++) {
                    for (var i = 0; i < data[0].quotesDetails.length; i++) {
                        if (data[0].boqSummary[r].boqsheetName == data[0].quotesDetails[i].boqsheetName) {
                            ...
                            if (data[0].quotesDetails[i].srno == 1 && data[0].quotesDetails[i].rfqParameterParentID == "0" && data[0].quotesDetails[i].rfqtcid == "0") {
                                ...
                                if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                    totalamount = data[0].quotesDetails[i].rfqVendorPricewithTax * data[0].quotesDetails[i].quantity;
                                    if (_basicPrice > 0) {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td  style="width:5%!important;"><button type=button  data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + '  class="btn iconbtn accordion-toggle" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td>' + data[0].quotesDetails[i].srno + '</td><td id=shortSP' + pid + ' style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithoutGST).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithTax).round(2)) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + '><tr name=' + sheet.split(' ').join('_') + '><td style="width:5%!important;"  style="width:5%!important;"><button type=button data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + '  class="btn iconbtn accordion-toggle" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td>' + data[0].quotesDetails[i].srno + '</td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithoutGST).round(2)) + '</b></td><td class=text-right><b>' + thousands_separators((data[0].quotesDetails[i].rfqVendorPricewithTax).round(2)) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                    else {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td  style="width:5%!important;"><button type=button data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + '  class="btn iconbtn accordion-toggle" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td>' + data[0].quotesDetails[i].srno + '</td><td style="width:40%!important;" id=shortSP' + pid + '><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                        jQuery('#tblServicesProductforexcel').append('<thead id=headidE' + i + '><tr name=' + sheet.split(' ').join('_') + '><td   style="width:5%!important;"><button type=button data-toggle=collapse data-target=#demoPE' + i + data[0].quotesDetails[i].srno + '  class="btn iconbtn accordion-toggle" onclick="fncollapse(MainItemPE' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemPE' + i + ' ></span></button></td><td>' + data[0].quotesDetails[i].srno + '</td><td style="width:40%!important;"><b>' + data[0].quotesDetails[i].rfqShortName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>Not Quoted</b></td><td class=text-right><b>Not Quoted</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                    }
                                    totalamountsum = totalamountsum + totalamount;
                                    withoutGSTValue = data[0].quotesDetails[i].rfqVendorPricewithoutGST
                                }
                                ...
                                for (var j = 0; j < data[0].quotesDetails.length; j++) {
                                    if (j == 0) {
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + thousands_separators((data[0].quotesDetails[i].unitRate).round(2)) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + thousands_separators((data[0].quotesDetails[i].unitRate).round(2)) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                        }
                                        else {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                    ...
                                    if (data[0].quotesDetails[j].rfqtcid != 0 && data[0].quotesDetails[i].rfqParameterId == data[0].quotesDetails[j].rfqParameterId) {
                                        ...
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + (data[0].quotesDetails[j].termRate) + '%</td><td class=text-right>' + thousands_separators(bsicpercentageofGST.round(2)) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + data[0].quotesDetails[j].termRate + '%</td><td class=text-right>' + thousands_separators(bsicpercentageofGST.round(2)) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                        }
                                        else {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Quoted</td><td class=text-right>Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Quoted</td><td class=text-right>Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>Not Quoted</td><td class=text-right>Not Quoted</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                ...
                                for (var j = counter; j < data[0].quotesDetails.length; j++) {
                                    ...
                                    if (data[0].quotesDetails[i].uom == "" && data[0].quotesDetails[j].uom == "" && data[0].quotesDetails[j].rfqParameterParentID == "0" && data[0].quotesDetails[i].boqsheetName == data[0].quotesDetails[j].boqsheetName && data[0].quotesDetails[j].rfqtcid == "0") {//&& data[0].quotesDetails[i].quantity == 0
                                        if (data[0].quotesDetails[j].srno == 1 && data[0].quotesDetails[j].rfqtcid == "0") {
                                            $("#headidE" + i).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demoPE" + i + srno + "' style='padding-left:0px!important'></div></tr>");
                                            $("#headid" + i).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demoP" + i + srno + "' style='padding-left:0px!important'></div></tr>");
                                        }
                                        ...
                                        $("#demoPE" + i + data[0].quotesDetails[i].srno).append("<table id=TblMHPE" + srno + sheet.split(' ').join('_') + " class='table table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");
                                        $("#demoP" + i + data[0].quotesDetails[i].srno).append("<table id=TblMHP" + srno + sheet.split(' ').join('_') + " class='table table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");

                                        $('#TblMHPE' + srno + sheet.split(' ').join('_')).append("<tbody><tr name=" + sheet.split(' ').join('_') + "><td style='width:1%!important'><button type='button' data-toggle=collapse  data-target='#demo1E" + j + srno + "'  class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem1E" + srno + j + ")'><span class='glyphicon glyphicon-plus' id='mainItem1E" + srno + j + "'></span></button></td><td class=text-right style='width:4% !important'>" + srno + "</td><td id=shortE" + pid + " style='width:40.5%!important'>" + data[0].quotesDetails[j].rfqShortName + "</td><td><label class=" + sheet.split(' ').join('_') + " name=" + parentid + " id=lblPTot" + pid + "><b>" + thousands_separators((data[0].quotesDetails[j].itemPrice).round(2)) + "</b></label></td><td class='hide rPID' id=rPIDE" + srno + ">" + pid + "</td></tr></tbody>");
                                        $('#TblMHP' + srno + sheet.split(' ').join('_')).append("<tbody><tr name=" + sheet.split(' ').join('_') + "><td style='width:1%!important' ><button type='button' data-toggle=collapse  data-target='#demo1P" + j + srno + "'  class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem1P" + srno + j + ")'><span class='glyphicon glyphicon-plus' id='mainItem1P" + srno + j + "'></span></button></td><td class=text-right style='width:4% !important'>" + srno + "</td><td id=shortP" + pid + " style='width:40.5%!important'>" + data[0].quotesDetails[j].rfqShortName + "</td><td><label class=" + sheet.split(' ').join('_') + " name=" + parentid + " id=lblPTotP" + pid + "><b>" + thousands_separators((data[0].quotesDetails[j].itemPrice).round(2)) + "</b></label></td><td class='hide rPID' id=rPIDP" + srno + ">" + pid + "</td></tr></tbody>");
                                        ...
                                        for (var k = j; k < data[0].quotesDetails.length; k++) {
                                            if (data[0].quotesDetails[k].rfqtcid == "0" && data[0].quotesDetails[j].rfqParameterParentID == "0" && data[0].quotesDetails[k].rfqParameterParentID == "0" && data[0].quotesDetails[i].uom == "" && data[0].quotesDetails[k].boqsheetName == data[0].quotesDetails[j].boqsheetName) {//&& data[0].quotesDetails[i].quantity == 0
                                                if (data[0].quotesDetails[j].rfqtcid == "0" && data[0].quotesDetails[k].srno == data[0].quotesDetails[j].srno) {
                                                    $('#TblMHP' + srno + sheet.split(' ').join('_')).append("<tr><td colspan=19 class=hiddenRow><div class='accordian-body collapse' id='demo1P" + j + srno + "' style='padding-left:0px!important'><table id='TblMHP" + srno + k + "' class='table table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></tr>");
                                                    $('#TblMHPE' + srno + sheet.split(' ').join('_')).append("<tr><td colspan=19 class=hiddenRow><div class='accordian-body collapse' id='demo1PE" + j + srno + "' style='padding-left:0px!important'><table id='TblMHPE" + srno + k + "' class='table table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></tr>");

                                                }
                                                $('#TblMHP' + srno + k).append("<thead><tr><th style='width:8.2%!important'>Srno</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")
                                                $('#TblMHPE' + srno + k).append("<thead><tr><th style='width:8.2%!important'>Srno</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")
                                                ...
                                                for (var l = k; l < data[0].quotesDetails.length; l++) {
                                                    if (data[0].quotesDetails[l].rfqtcid == "0" && data[0].quotesDetails[l].rfqParameterParentID == "0" && data[0].quotesDetails[l].uom == "" && data[0].quotesDetails[k].rfqParameterId == data[0].quotesDetails[l].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[k].boqsheetName) {//&& data[0].quotesDetails[l].quantity == 0
                                                        ...
                                                        $('#TblMHP' + srno + k).append("<tr name=" + data[0].quotesDetails[l].boqsheetName.split(' ').join('_') + "><td style='width:5%!important'><button type='button' data-toggle='collapse' data-target='#demo12P" + l + "' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem12P" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem12P" + l + "'></span></button></td><td class=text-right>" + data[0].quotesDetails[l].srno + "</td><td class='hide rPID' id=rPIDP" + data[0].quotesDetails[l].srno + ">" + data[0].quotesDetails[l].rfqParameterId + "</td><td id=shortP" + data[0].quotesDetails[l].rfqParameterId + " style='width:42%!important'>" + data[0].quotesDetails[l].rfqShortName + "</td><td><b><label  name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTotP" + data[0].quotesDetails[l].rfqParameterId + ">" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</label><b></td></tr>");
                                                        $('#TblMHP' + srno + k).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demo12P" + l + "' style='padding-left:0px!important'></div></tr>");
                                                        $("#demo12P" + l).append("<table id=TblMH1P" + l + " class='table table-condensed table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");
                                                        $('#TblMH1P' + l).append("<thead><tr><th style='width:8.2%!important'>SrNo</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")

                                                        $('#TblMHPE' + srno + k).append("<tr name=" + data[0].quotesDetails[l].boqsheetName.split(' ').join('_') + "><td style='width:5%!important' ><button data-toggle='collapse' data-target='#demo12PE" + l + "' type='button' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem12PE" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem12PE" + l + "'></span></button></td><td class=text-right>" + data[0].quotesDetails[l].srno + "</td><td class='hide rPID' id=rPIDPE" + data[0].quotesDetails[l].srno + ">" + data[0].quotesDetails[l].rfqParameterId + "</td><td id=shortPE" + data[0].quotesDetails[l].rfqParameterId + " style='width:42%!important'>" + data[0].quotesDetails[l].rfqShortName + "</td><td><b><label  name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTotPE" + data[0].quotesDetails[l].rfqParameterId + ">" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</label><b></td></tr>");
                                                        $('#TblMHPE' + srno + k).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demo12PE" + l + "' style='padding-left:0px!important'></div></tr>");
                                                        $("#demo12PE" + l).append("<table id=TblMH1PE" + l + " class='table table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");
                                                        $('#TblMH1PE' + l).append("<thead><tr><th style='width:8.2%!important'>SrNo</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")
                                                        ...
                                                        for (var m = l; m < data[0].quotesDetails.length; m++) {
                                                            if (data[0].quotesDetails[m].uom == "" && data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[m].boqsheetName) { //&& data[0].quotesDetails[m].quantity == 0
                                                                $('#TblMHPE' + l).append("<tr name=" + sheet.split(' ').join('_') + "><td style='width:5%!important'><button data-toggle='collapse' data-target='#demo123E" + m + "' type='button' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem12E" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem12E" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='rPID hide' id=rPIDE" + srno + ">" + pid + "</td><td id=shortE" + data[0].quotesDetails[l].rfqParameterId + " style='width:42%!important'>" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=17><label class=thousandseparated  name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTot" + data[0].quotesDetails[l].rfqParameterId + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                                $('#TblMHP' + l).append("<tr name=" + sheet.split(' ').join('_') + "><td style='width:5%!important' ><button type='button' data-target='#demo123P" + m + "' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem12P" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem12P" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='rPID hide' id=rPIDP" + srno + ">" + pid + "</td><td id=shortP" + data[0].quotesDetails[l].rfqParameterId + " style='width:42%!important'>" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=17><label class=thousandseparated  name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTotP" + data[0].quotesDetails[l].rfqParameterId + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                            }
                                                            else if (data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID) {
                                                                $('#TblMH1PE' + l).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td class=text-right >' + data[0].quotesDetails[m].srno + '</td><td id=shortP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanP' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[m].quantity).round(2)) + '</td><td id=uomP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="form-control thousandseparated text-right">' + thousands_separators((data[0].quotesDetails[m].itemPrice).round(2)) + '</td><td id=commP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                        ...
                                                        $('#TblMHP' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + srno + '>' + pid + '</td><td class=text-right >' + srno + '</td><td id=shortP' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanP' + pid + '>' + thousands_separators((data[0].quotesDetails[l].quantity).round(2)) + '</td><td id=uomP' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + '</td><td id=commP' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                        $('#TblMHPE' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDPE' + srno + '>' + pid + '</td><td class=text-right>' + srno + '</td><td id=shortPE' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanPE' + pid + '>' + thousands_separators((data[0].quotesDetails[l].quantity).round(2)) + '</td><td id=uomPE' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + '</td><td id=commPE' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                    }
                                                        ...
                                                        $('#TblMHP' + data[0].quotesDetails[j].srno + k).append("<tr name=" + sheet.split(' ').join('_') + "><td style='width:5%!important' ><button type='button' data-toggle='collapse'  data-target='#demo12P" + l + data[0].quotesDetails[j].srno + "' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem122P" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem122P" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='hide rPID' id=rPIDP" + srno + ">" + pid + "</td><td colspan='3' id=shortP" + pid + ">" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=7><b><label class=thousandseparated name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTotP" + data[0].quotesDetails[l].rfqParameterId + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                        $('#TblMHP' + data[0].quotesDetails[j].srno + k).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demo12P" + l + data[0].quotesDetails[j].srno + "' style='padding-left:0px!important'></div></tr>");

                                                        $('#TblMHPE' + data[0].quotesDetails[j].srno + k).append("<tr name=" + sheet.split(' ').join('_') + "><td style='width:5%!important' ><button type='button' data-toggle='collapse'  data-target='#demo12PE" + l + data[0].quotesDetails[j].srno + "' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem122PE" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem122PE" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='hide rPID' id=rPIDPE" + srno + ">" + pid + "</td><td colspan='3' id=shortPE" + pid + ">" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=7><b><label class=thousandseparated name=" + data[0].quotesDetails[l].rfqParameterParentID + "  id=lblPTotPE" + data[0].quotesDetails[l].rfqParameterId + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                        $('#TblMHPE' + data[0].quotesDetails[j].srno + k).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demo12PE" + l + data[0].quotesDetails[j].srno + "' style='padding-left:0px!important'></div></tr>");

                                                        $("#demo12P" + l + data[0].quotesDetails[j].srno).append("<table id=TblMH1P" + l + data[0].quotesDetails[j].srno + " class='table table-condensed table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");
                                                        $('#TblMH1P' + l + data[0].quotesDetails[j].srno).append("<thead><tr><th style='width:8.2%!important'>SrNo</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")


                                                        $("#demo12PE" + l + data[0].quotesDetails[j].srno).append("<table id=TblMH1PE" + l + data[0].quotesDetails[j].srno + " class='table table-condensed table-striped table-bordered BoqTable' cellpadding=0 cellspacing=0></table>");
                                                        $('#TblMH1PE' + l + data[0].quotesDetails[j].srno).append("<thead><tr><th style='width:8.2%!important'>SrNo</th><th style='width:41.2%!important'>Item Name</th><th style='width:5%!important'>Quantity</th><th style='width:10%!important'>UOM</th><th style='width:20%!important'>Price</th><th style='width:20%!important'>Comments</th></tr></thead>")
                                                        for (var m = l; m < data[0].quotesDetails.length; m++) {

                                                            if (data[0].quotesDetails[m].rfqUomId == "" && data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[m].boqsheetName) { //&& data[0].quotesDetails[m].quantity == ""
                                                                $('#TblMHPE' + l).append("<tr name=" + sheet.split(' ').join('_') + "><td data-toggle='collapse' class='accordion-toggle'  data-target='#demo123P" + m + "' style='width:5%!important' ><button type='button' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem122PE" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem122PE" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='hide rPID' id=rPIDP" + srno + ">" + pid + "</td><td colspan='3' id=shortP" + pid + ">" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=17><label class=thousandseparated name=" + parentid + " id=lblPTotP" + pid + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                                $('#TblMHP' + l).append("<tr name=" + sheet.split(' ').join('_') + "><td data-toggle='collapse' class='accordion-toggle'  data-target='#demo123P" + m + "' style='width:5%!important' ><button type='button' class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem122P" + l + ")' ><span class='glyphicon glyphicon-plus' id='mainItem122P" + l + "'></span></button></td><td class=text-right>" + srno + "</td><td class='hide rPID' id=rPIDP" + srno + ">" + pid + "</td><td colspan='3' id=shortP" + pid + ">" + data[0].quotesDetails[l].rfqShortName + "</td><td colspan=17><label class=thousandseparated name=" + parentid + " id=lblPTotP" + pid + "><b>" + thousands_separators((data[0].quotesDetails[l].itemPrice).round(2)) + "</b></label></td></tr>");
                                                            }
                                                            else if (data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID) {
                                                                $('#TblMH1PE' + l + data[0].quotesDetails[j].srno).append('<tr name=' + data[0].quotesDetails[m].boqsheetName.split(' ').join('_') + '><td class="hide rPID" id=rPIDE' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td>' + data[0].quotesDetails[m].srno + '</td><td id=shortPE' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanPE' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[m].quantity).round(2)) + '</td><td id=uomPE' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="text-right"  >' + thousands_separators((data[0].quotesDetails[m].itemPrice).round(2)) + '</td><td id=commPE' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                                $('#TblMH1P' + l + data[0].quotesDetails[j].srno).append('<tr name=' + data[0].quotesDetails[m].boqsheetName.split(' ').join('_') + '><td class="hide rPID" id=rPID' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td>' + data[0].quotesDetails[m].srno + '</td><td id=shortP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanP' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[m].quantity).round(2)) + '</td><td id=uomP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="text-right"  >' + thousands_separators((data[0].quotesDetails[m].itemPrice).round(2)) + '</td><td id=commP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                            }
                                                        }
                                                    }
                                    ...
                                    else if (data[0].quotesDetails[j].rfqtcid == "0" && data[0].quotesDetails[i].rfqParameterParentID == "0" && data[0].quotesDetails[j].boqsheetName == data[0].quotesDetails[i].boqsheetName) {//&& data[0].parameters[i].rfqParameterParentID == "0"
                                        if (data[0].quotesDetails[j].rfqtcid == "0" && data[0].quotesDetails[i].srno == data[0].quotesDetails[j].srno) {
                                            $("#headidE" + i).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demoPE" + i + srno + "' style='padding-left:0px!important'></div></tr>");
                                            $("#headid" + i).append("<tr><td colspan=20 class=hiddenRow><div class='accordian-body collapse' id='demoP" + i + srno + "' style='padding-left:0px!important'></div></tr>");
                                        }
                                        pid = data[0].quotesDetails[j].rfqParameterId;
                                        ...
                                        $('#TblMHP' + srno + sheet.split(' ').join('_')).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPID' + data[0].quotesDetails[j].srno + '>' + data[0].quotesDetails[j].rfqParameterId + '</td><td class=text-right style="width:9%!important" >' + data[0].quotesDetails[j].srno + '</td><td style="width:23%!important" id=short' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].rfqShortName + '</td><td  style="width:6.2%!important" id=quan' + data[0].quotesDetails[j].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[j].quantity).round(2)) + '</td><td style="width:12.8%!important" id=uom' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].uom + '</td><td class="thousandseparated text-right">' + thousands_separators((data[0].quotesDetails[j].itemPrice).round(2)) + '</td><td id=commP' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].vendorItemRemarks + '</td></tr>');
                                        $('#TblMHPE' + srno + sheet.split(' ').join('_')).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + data[0].quotesDetails[j].srno + '>' + data[0].quotesDetails[j].rfqParameterId + '</td><td class=text-right style="width:9%!important" >' + data[0].quotesDetails[j].srno + '</td><td style="width:23%!important" id=shortP' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].rfqShortName + '</td><td  style="width:6.2%!important" id=quanP' + data[0].quotesDetails[j].rfqParameterId + '>' + thousands_separators((data[0].quotesDetails[j].quantity).round(2)) + '</td><td style="width:12.8%!important" id=uomP' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].uom + '</td><td class="thousandseparated text-right">' + thousands_separators((data[0].quotesDetails[j].itemPrice).round(2)) + '</td><td id=commP' + data[0].quotesDetails[j].rfqParameterId + '>' + data[0].quotesDetails[j].vendorItemRemarks + '</td></tr>');
                                    }
                                }
