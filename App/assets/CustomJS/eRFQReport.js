                        ...
                        if (data[0].boqSummary[r].boqsheetName == data[0].quotesDetails[i].boqsheetName) {
                            ...
                            if (data[0].quotesDetails[i].srno == 1 && data[0].quotesDetails[i].rfqParameterParentID == "0" && data[0].quotesDetails[i].rfqtcid == "0") {
                                ...
                                if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                    totalamount = data[0].quotesDetails[i].rfqVendorPricewithTax * data[0].quotesDetails[i].quantity;
                                    if (_basicPrice > 0) {
                                        jQuery('#tblServicesProduct').append('<thead id=headid' + i + '><tr name=' + sheet.split(' ').join('_') + ' style="background: #ccc; color:grey;"><td  style="width:5%!important;"><button type=button  data-toggle=collapse data-target=#demoP' + i + data[0].quotesDetails[i].srno + '  class="btn iconbtn accordion-toggle" onclick="fncollapse(MainItemP' + i + ')"><span class="glyphicon glyphicon-plus" id=MainItemP' + i + ' ></span></button></td><td class="hide rPID" id=rPIDP' + sheet + srno + '>' + pid + '</td><td>' + data[0].quotesDetails[i].srno + '</td><td id=shortSP' + pid + ' style="width:40%!important;"><b>' + data[0].quotesDetails[i].boqsheetName + '&nbsp(TC Given Below)</b></td><td><b>' + data[0].quotesDetails[i].uom + '</b></td><td class=text-right><b>' + thousands_separators(data[0].quotesDetails[i].rfqVendorPricewithoutGST) + '</b></td><td class=text-right><b>' + thousands_separators(data[0].quotesDetails[i].rfqVendorPricewithTax) + '</b></td><td><b>' + description + '</b></td><td><b>' + comments + '</b></td></tr></thead>');
                                ...
                                for (var j = 0; j < data[0].quotesDetails.length; j++) {
                                    if (j == 0) {
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + (data[0].quotesDetails[i].unitRate) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>Basic Price</td><td>' + '' + '</td><td  class=text-right>' + '' + '</td><td class=text-right>' + (data[0].quotesDetails[i].unitRate) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                    ...
                                    if (data[0].quotesDetails[j].rfqtcid != 0 && data[0].quotesDetails[i].rfqParameterId == data[0].quotesDetails[j].rfqParameterId) {
                                        ...
                                        if (sessionStorage.getItem('ShowPrice') == "Y" || sessionStorage.getItem('ShowPrice') == "") {
                                            if (_basicPrice > 0) {
                                                jQuery("#tblServicesProduct > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + (data[0].quotesDetails[j].termRate) + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                                jQuery("#tblServicesProductforexcel  > #headid" + i + "").append('<tr id=trid' + j + '><td></td><td></td><td>' + data[0].quotesDetails[j].termName + '</td><td>' + '' + '</td><td  class=text-right>' + data[0].quotesDetails[j].termRate + '%</td><td class=text-right>' + bsicpercentageofGST.round(2) + '</td><td>' + '' + '</td><td>' + '' + '</td></tr>');
                                            }
                                            else {
                                ...
                                for (var j = counter; j < data[0].quotesDetails.length; j++) {
                                    ...
                                    if (data[0].quotesDetails[i].uom == "" && data[0].quotesDetails[j].uom == "" && data[0].quotesDetails[j].rfqParameterParentID == "0" && data[0].quotesDetails[i].boqsheetName == data[0].quotesDetails[j].boqsheetName && data[0].quotesDetails[j].rfqtcid == "0") {//&& data[0].quotesDetails[i].quantity == 0
                                        ...
                                        $('#TblMHPE' + srno + sheet.split(' ').join('_')).append("<tbody><tr name=" + sheet.split(' ').join('_') + "><td style='width:1%!important'><button type='button' data-toggle=collapse  data-target='#demo1E" + j + srno + "'  class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem1E" + srno + j + ")'><span class='glyphicon glyphicon-plus' id='mainItem1E" + srno + j + "'></span></button></td><td class=text-right style='width:4% !important'>" + srno + "</td><td id=shortE" + pid + " style='width:40.5%!important'>" + data[0].quotesDetails[j].rfqShortName + "</td><td><label class=" + sheet.split(' ').join('_') + " name=" + parentid + " id=lblPTot" + pid + "><b>" + thousands_separators(data[0].quotesDetails[j].itemPrice) + "</b></label></td><td class='hide rPID' id=rPIDE" + srno + ">" + pid + "</td></tr></tbody>");
                                        $('#TblMHP' + srno + sheet.split(' ').join('_')).append("<tbody><tr name=" + sheet.split(' ').join('_') + "><td style='width:1%!important' ><button type='button' data-toggle=collapse  data-target='#demo1P" + j + srno + "'  class='btn iconbtn accordion-toggle' onclick='fncollapse(mainItem1P" + srno + j + ")'><span class='glyphicon glyphicon-plus' id='mainItem1P" + srno + j + "'></span></button></td><td class=text-right style='width:4% !important'>" + srno + "</td><td id=shortP" + pid + " style='width:40.5%!important'>" + data[0].quotesDetails[j].rfqShortName + "</td><td><label class=" + sheet.split(' ').join('_') + " name=" + parentid + " id=lblPTotP" + pid + "><b>" + thousands_separators(data[0].quotesDetails[j].itemPrice) + "</b></label></td><td class='hide rPID' id=rPIDP" + srno + ">" + pid + "</td></tr></tbody>");
                                                    ...
                                                    if (data[0].quotesDetails[l].rfqtcid == "0" && data[0].quotesDetails[l].rfqParameterParentID == "0" && data[0].quotesDetails[l].uom == "" && data[0].quotesDetails[k].rfqParameterId == data[0].quotesDetails[l].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[k].boqsheetName) {//&& data[0].quotesDetails[l].quantity == 0
                                                        ...
                                                        for (var m = l; m < data[0].quotesDetails.length; m++) {
                                                            if (data[0].quotesDetails[m].uom == "" && data[0].quotesDetails[l].rfqParameterId == data[0].quotesDetails[m].rfqParameterParentID && data[0].quotesDetails[l].boqsheetName == data[0].quotesDetails[m].boqsheetName) { //&& data[0].quotesDetails[m].quantity == 0
                                                                ...
                                                                $('#TblMH1PE' + l).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + data[0].quotesDetails[m].srno + '>' + data[0].quotesDetails[m].rfqParameterId + '</td><td class=text-right >' + data[0].quotesDetails[m].srno + '</td><td id=shortP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].rfqShortName + '</td><td id=quanP' + data[0].quotesDetails[m].rfqParameterId + '>' + thousands_separators(data[0].quotesDetails[m].quantity) + '</td><td id=uomP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].uom + '</td><td class="form-control thousandseparated text-right">' + thousands_separators(data[0].quotesDetails[m].itemPrice) + '</td><td id=commP' + data[0].quotesDetails[m].rfqParameterId + '>' + data[0].quotesDetails[m].vendorItemRemarks + '</td></tr>');
                                                        ...
                                                        $('#TblMHP' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDP' + srno + '>' + pid + '</td><td class=text-right >' + srno + '</td><td id=shortP' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanP' + pid + '>' + thousands_separators(data[0].quotesDetails[l].quantity) + '</td><td id=uomP' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators(data[0].quotesDetails[l].itemPrice) + '</td><td id=commP' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                        $('#TblMHPE' + data[0].quotesDetails[j].srno + k).append('<tr name=' + sheet.split(' ').join('_') + '><td class="hide rPID" id=rPIDPE' + srno + '>' + pid + '</td><td class=text-right>' + srno + '</td><td id=shortPE' + pid + '>' + data[0].quotesDetails[l].rfqShortName + '</td><td id=quanPE' + pid + '>' + thousands_separators(data[0].quotesDetails[l].quantity) + '</td><td id=uomPE' + pid + '>' + data[0].quotesDetails[l].uom + '</td><td class="text-right" >' + thousands_separators(data[0].quotesDetails[l].itemPrice) + '</td><td id=commPE' + pid + ' >' + data[0].quotesDetails[l].vendorItemRemarks + '</td></tr>');
                                                    }
