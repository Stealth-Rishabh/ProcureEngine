$("#cancelBidBtn").hide();
//abheedev bug 507 commented for reference
/*jQuery(document).ready(function () {
    $("").inputmask({ //,#txttargetprice,#txtunitrate,#txtpovalue,#txtquantitiy,#txtCeilingPrice,#txtminimumdecreament,#txtitembidduration,#txtlastinvoiceprice
       alias: "decimal",
        rightAlign: false,
        groupSeparator: ",",
        radixPoint: ".",
