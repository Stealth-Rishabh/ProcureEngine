            ...
            success: function (data, status, jqXHR) {
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].itemStatus.toLowerCase() == "close" || data[i].itemStatus.toLowerCase() == "inactive" || data[i].itemStatus.toLowerCase() == "pause") {
