...
if (window.location.search) {
    ...
    sessionStorage.setItem("EventType", 'RFQ');
...
function RFQFetchTotalPriceForReport(VendorID, Counter) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            if (ShowPrice == "Y") {
                $("#totBoxwithoutgst" + VendorID).html(thousands_separators((data[0].totalPriceExTax || 0).round(2)));
                $("#totBoxwithgst" + VendorID).html(thousands_separators((data[0].totalPriceIncTax || 0).round(2)));
                $("#totBoxTax" + VendorID).html(thousands_separators((data[0].totalPriceIncTax || 0).round(2)));
                $("#totBoxwithoutgstExcel" + VendorID).html(thousands_separators((data[0].totalPriceExTax || 0).round(2)));
                $("#totBoxwithgstExcel" + VendorID).html(thousands_separators((data[0].totalPriceIncTax || 0).round(2)));
                $("#totBoxTaxExcel" + VendorID).html(thousands_separators((data[0].totalPriceIncTax || 0).round(2)));
            }
            else {
...
function RFQFetchL1Package(VendorID, Counter) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            $("#withoutGSTL1RankExcel" + VendorID).html((data[0].totalL1RankWithoutGST).round(2));
            ...
            $("#totL1Rank" + VendorID).html(thousands_separators((data[0].totalL1RankWithGST).round(2)));
            $("#totL1RankExcel" + VendorID).html(thousands_separators((data[0].totalL1RankWithGST).round(2)));
    ...
    jQuery.ajax({
        ...
        success: function (Data, status, jqXHR) {
            ...
            if (data[0].vendorNames.length > 0) {
                ...
                $('#displayTable').show();
                $('#displayComparativetabs').show();
                $('<tr><td style="color:red !important; text-align: center;" colspan="5"> No results </td></tr>').appendTo('#tblRFQComprativeBoq');
                $('<tr><td style="color:red !important; text-align: center;" colspan="5"> No results </td></tr>').appendTo("#tblRFQComprativeBoqForExcel")
