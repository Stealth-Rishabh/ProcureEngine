...
function fetchUserBids() {
    ...
    jQuery.ajax({
        ...
        url: APIPath + "ResetInviteVendor/fetchBidsAuto/?UserID=A&BidID=0&CustomerID=" + sessionStorage.getItem('CustomerID'),
...
function fetchvendors(bidid) {
    ...
    jQuery.ajax({
        type: "GET",
        contentType: "application/json; charset=utf-8",
        url: APIPath + "ResetInviteVendor/fetchBidsAuto/?UserID=B&BidID=" + bidid + "&CustomerID=" + sessionStorage.getItem('CustomerID'),
        beforeSend: function (xhr, settings) { xhr.setRequestHeader('Authorization', 'Bearer ' + sessionStorage.getItem("Token")); },
        data: "{}",
        cache: false,
        dataType: "json",
    ...
    jQuery.ajax({
        ...
        success: function (BidData) {
            ...
            if (sessionStorage.getItem('hdnbidtypeid') == 7) {
                ...
                if (BidData[0].bidSeaExportDetails.length > 0) {
                    ...
                    for (var i = 0; i < BidData[0].bidVendorDetails.length; i++) {
                        if (BidData[0].bidDetails[0].bidForID == 81 || BidData[0].bidDetails[0].bidForID == 83) {
                            jQuery('#selectedvendorlistsPrev').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td>' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>');
                            jQuery('#selectedvendorlistsPrevtab_0').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td class=text-right>' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>')
                            ...
                            jQuery('#selectedvendorlistsPrev').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td class=hide>' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>');
                            jQuery('#selectedvendorlistsPrevtab_0').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td class="text-right hide">' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>')
                ...
                if (BidData[0].bidCoalDetails.length > 0) {
                    ...
                    for (var i = 0; i < BidData[0].bidCoalDetails.length; i++) {
                        ...
                        if ($('#hdnClosingval').val() == "S") {
                            ...
                            if (BidData[0].bidDetails[0].bidForID == "81" || BidData[0].bidDetails[0].bidForID == "1") {
                                jQuery("#tblServicesProductPrevtab_0").append("<tbody><tr id=trid" + i + "><td style='width:150px !important;'><a class='isDisabledClass' onclick=editValues('\divbidItemsPrevtab_0\',\'trid" + i + "\') ><i class='fa fa-pencil'></i></a></td><td>" + (i + 1) + "</td><td>" + BidData[0].bidCoalDetails[i].destinationPort + "</td><td>" + BidData[0].bidCoalDetails[i].remarks + "</td><td class=text-right>" + BidData[0].bidCoalDetails[i].targetprice + "</td><td class=text-right>" + BidData[0].bidCoalDetails[i].gst + "</td><td class=text-right>" + thousands_separators(BidData[0].bidCoalDetails[i].quantity) + "</td><td>" + BidData[0].bidCoalDetails[i].uom + "</td><td class=text-right>" + thousands_separators(BidData[0].bidCoalDetails[i].ceilingPrice) + " <a class='changeMinDecreament ml-1' onclick=editbidstartpriceCA(" + BidData[0].bidCoalDetails[i].coalID + ",\'trid" + i + "\')><i class='fa fa-pencil'></i></a></td><td>" + BidData[0].bidCoalDetails[i].maskVendor + "</td><td class=text-right>" + BidData[0].bidCoalDetails[i].minimumDecreament + " <a class='changeMinDecreament ml-1' onclick=editMinDecreament(" + BidData[0].bidCoalDetails[i].coalID + ",\'trid" + i + "\')><i class='fa fa-pencil'></i></a></td><td>" + decrementon + "</td><td class=hide>" + BidData[0].bidCoalDetails[i].decreamentOn + "</td><td class=text-right>" + thousands_separators(BidData[0].bidCoalDetails[i].lastInvoicePrice) + "</td><td class=hide>" + BidData[0].bidCoalDetails[i].coalID + "</td><td>" + BidData[0].bidCoalDetails[i].maskL1Price + "&nbsp;<a class='lambdafactor' onclick=editShowL1Price(" + BidData[0].bidCoalDetails[i].coalID + ",\'trid" + i + "\') class=pencilHLP ><i class='fa fa-pencil'></i></a></td><td>" + BidData[0].bidCoalDetails[i].showStartPrice + "&nbsp;<a class='' onclick=editShowStartPrice(" + BidData[0].bidCoalDetails[i].coalID + ",\'trid" + i + "\')><i class='fa fa-pencil'></i></a></td><td class=text-right>" + thousands_separators(BidData[0].bidCoalDetails[i].poUnitRate) + "</td><td>" + BidData[0].bidCoalDetails[i].poNo + "</td><td>" + BidData[0].bidCoalDetails[i].poVendorName + "</td><td>" + BidData[0].bidCoalDetails[i].poDate + "</td><td class=text-right>" + thousands_separators(BidData[0].bidCoalDetails[i].poValue) + "</td></tr></tbody>");
                            }
                            else {
                    ...
                    for (var i = 0; i < BidData[0].bidVendorDetails.length; i++) {
                        ...
                        jQuery('#selectedvendorlistsPrev').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td></tr></tbody>');
                        jQuery('#selectedvendorlistsPrevtab_0').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td></tr></tbody>')
                        $('#thloadingfactor').hide();
                    }
            ...
            if (sessionStorage.getItem('hdnbidtypeid') == 6) {
                ...
                for (var i = 0; i < BidData[0].bidVendorDetails.length; i++) {
                    jQuery('#selectedvendorlistsPrev').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td>' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>');
                    jQuery('#selectedvendorlistsPrevtab_0').append('<tbody><tr ><td class=hide>' + BidData[0].bidVendorDetails[i].vendorID + '</td><td>' + BidData[0].bidVendorDetails[i].vendorName + '</td><td>' + BidData[0].bidVendorDetails[i].advFactor + '</td></tr></tbody>')
                }
                jQuery('#tblparicipantslists> tbody').empty()
                for (var i = 0; i < BidData[0].bidVendorDetails.length; i++) {
...
function addBidApprovers() {
    ...
    if ($('#hdnBidApproverID').val() == "0" || jQuery("#txtApproverBid").val() == "") {
        ...
        if (!jQuery("#tblBidapprovers thead").length) {
            ...
            jQuery("#tblBidapprovers <tbody>").append(`<tbody><tr id='trAppid${rowBidApp}'><td><button class="btn  btn-xs btn-danger" onclick="deleteBidApprow('trAppid${rowBidApp}')" ><i class="glyphicon glyphicon-remove-circle"></i></button></td><td>${UserName}</td><td>${EmailID}</td><td>${rowBidApp}</td><td class=hide>${UserID}</td></tr></tbody>`);
        }
        else {
            jQuery("#tblBidapprovers <tbody>").append(`<tbody><tr id='trAppid${rowBidApp}'><td><button class="btn  btn-xs btn-danger" onclick="deleteBidApprow('trAppid${rowBidApp}')" ><i class="glyphicon glyphicon-remove-circle"></i></button></td><td>${UserName}</td><td>${EmailID}</td><td>${rowBidApp}</td><td class=hide>${UserID}</td></tr></tbody>`);
        }
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].isApprover != "P") {
                    rowBidApp = rowBidApp + 1;
                    str = '<tbody><tr id=trAppid' + rowBidApp + '>';
                    ...
                    str += "<td class=hide>" + data[i].userID + "</td></tr></tbody>";
...
function fnGetPauseHistory() {
    ...
    jQuery.ajax({
        ...
        success: function (data, status, jqXHR) {
            ...
            $("#tblbidpauseHistory").append(`<thead></thead><tbody></tbody>`);
            if (data.length > 0) {
                $('#divpausehitory').removeClass('hide');

                $("#tblbidpauseHistory>thead").append("<tr style='background: gray; color: #FFF'><th>S No</th><th>Paused Item</th><th>Pause Date Time</th><th>Re Open Date Time</th><th>Balance Duration (mins)</th>");
                for (var i = 0; i < data.length; i++) {
                    ...
                    $("#tblbidpauseHistory>tbody").append('<tr><td>' + (i + 1) + '</td><td>' + data[i].destinationport + '</td><td>' + bidPauseDate + '</td><td>' + bidReopenDate + '</td><td>' + data[i].bidDuration + '</td></tr>');
                }
            }
            else {
                $('#divpausehitory').addClass('hide');
                jQuery("#tblbidpauseHistory>tbody").append("<tr><td>No Data Found</td></tr>")
            }
