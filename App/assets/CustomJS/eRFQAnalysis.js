    ...
    jQuery.ajax({
        ...
        success: function (data, status, jqXHR) {
            ...
            if (data[0].vendorNames.length > 0) {
                ...
                strHeadExcelQ = "<tr><th colspan=5>Question</th><th>Our Requirement</th>"
                            ...
                            if ((data[0].quotesDetails[i].rfqParameterId) == (data[0].quotesDetails[j].rfqParameterId)) {// true that means reflect on next vendor
                                ...
                                if (data[0].quotesDetails[j].vendorID == data[0].vendorNames[x].vendorID) {
                                    ...
                                    if (ShowPrice == "N" && data[0].quotesDetails[j].unitRate != 0 && data[0].quotesDetails[j].rfqVendorPricewithoutGST != 0 && data[0].quotesDetails[j].rfqVendorPricewithoutGST != -1 && data[0].quotesDetails[j].rfqVendorPricewithoutGST != -2) {
                                        ...
                                        strExcel += "<td>" + data[0].quotesDetails[j].rfqVendorPricewithoutGST + "</td><td>" + data[0].quotesDetails[j].rfqVendorPricewithGST + "</td><td>" + thousands_separators(_totalWithoutGst) + "</td>";// abheedev 0211
                                        // str += "<td>" + data[0].quotesDetails[j].rfqVendorPricewithoutGST+ "</td><td>" + thousands_separators(data[0].quotesDetails[j].rfqVendorPricewithGST) + "</td><td class='VendorPriceWithTax  text-right' >" + thousands_separators(_totalWithoutGst) + "</td>";
                                        ...
                                        strExcel += "<td>" + data[0].quotesDetails[j].rfqVendorPricewithoutGST + "</td><td>" + data[0].quotesDetails[j].rfqVendorPricewithGST + "</td><td>" + thousands_separators(_totalWithoutGst) + "</td>";//abheedev 0211s
                ...
                strExcel += "<tr><td colspan=6><b>Total</b></td>";
                ...
                if (ShowPrice == "Y" || totallowestValue == 0) {
                    ...
                    strExcel += "<td>" + totallowestValue + "</td><td colspan=6>&nbsp;</td></tr>";
                }
                else {
                    if (totallowestValue != 0) {
                        ...
                        if (data[0].loadedFactor[k].vendorID == data[0].vendorNames[l].vendorID) {
                            ...
                            if (p != 0) {
                                if (ShowPrice == 'Y') {
                                    ...
                                    strExcel += "<td id=LFactorexcel" + data[0].vendorNames[k].vendorID + ">" + data[0].loadedFactor[k].loadedFactor + "</td><td id=LoadingFexcel" + data[0].vendorNames[k].vendorID + ">" + p + "</td><td>&nbsp;</td><td>&nbsp;</td>";
                                }
                                else {
                                    ...
                                    strExcel += "<td id=LFactorexcel" + data[0].vendorNames[k].vendorID + ">" + data[0].loadedFactor[k].loadedFactor + "</td><td id=LoadingFexcel" + data[0].vendorNames[k].vendorID + ">Quoted</td><td>&nbsp;</td><td>&nbsp;</td>";
                                }
                            }
                            else {
                ...
                strExcel += "<tr><td colspan=6 ><b>L1 Package</b></td>";
                for (var k = 0; k < data[0].vendorNames.length; k++) {
                    if (data[0].vendorNames[k].seqNo != 0) {
                        if (ShowPrice == 'Y') {
                ...
                if (data[0].commercialTerms.length > 0) {
                    ...
                    for (var p = 0; p < data[0].noOfTermsForRFQ[0].noOfTermsSelectedForRFQ; p++) {
                        ...
                        if (flag1 == 'T') {
                            ...
                            strExcel += "<tr><td>" + (p + 1) + "</td><td colspan=5>" + data[0].commercialTerms[p].termName + "</td>";
